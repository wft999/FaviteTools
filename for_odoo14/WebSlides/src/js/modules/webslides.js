...
export default class WebSlides {
  /**
	 ...
	 *            autoslide If a number is provided, it will allow autosliding
	 *            by said amount of milliseconds.
	 * @param {boolean}
	 *            changeOnClick If true, it will allow clicking on any place to
	 *            change the slide.
	 * @param {boolean}
	 *            loop Whether to go to first slide from last one or not.
	 * @param {number}
	 *            minWheelDelta Controls the amount of needed scroll to trigger
	 *            navigation.
	 * @param {boolean}
	 *            navigateOnScroll Whether scroll can trigger navigation or not.
	 * @param {number}
	 *            scrollWait Controls the amount of time to wait till navigation
	 *            can occur again with scroll.
	 * @param {number}
	 *            slideOffset Controls the amount of needed touch delta to
	 *            trigger navigation.
	 * @param {boolean}
	 *            showIndex Controls if the index can be shown.
	 */
  constructor({
    autoslide = true,
    changeOnClick = false,
  ...
  /**
	 ...
	 * 
	 * @param {!number}
	 *            slideI The slide index.
	 * @param {?boolean=}
	 *            forward Whether we're forcing moving forward/backwards. This
	 *            parameter is used only from the goNext, goPrev functions to
  ...
  /**
	 ...
	 * 
	 * @param {boolean}
	 *            isMovingForward Whether we're going forward or backwards.
	 * @param {Slide}
	 *            nextSlide Next slide.
	 * @param {Function}
	 *            callback Callback to be called upon finishing. This is an
	 *            async function so it'll happen once the scroll animation
	 *            finishes.
	 * @private
	 * @see scrollTo
	 */
  ...
  /**
	 * Transitions to a slide, without doing the scroll animation. If the page
	 * is already initialised and on mobile device, it will do a slide
	 * animation.
	 * 
	 * @param {boolean}
	 *            isMovingForward Whether we're going forward or backwards.
	 ...
	 *            nextSlide Next slide.
	 * @param {Function}
	 *            callback Callback to be called upon finishing. This is a sync
	 *            function so it'll happen on run time.
	 * @private
	 */
  ...
  /**
	 ...
	 * references to the current slide, disables the moving flag and fires a
	 * custom event.
	 * 
	 * @param {Slide}
	 *            slide The slide we're transitioning to.
  ...
  /**
	 ...
	 * 
	 * @param {!string}
	 *            key They key under which it'll be stored inside of the
	 *            instance, inside the plugins dict.
	 * @param {!Function}
	 *            cto Plugin constructor.
	 */
