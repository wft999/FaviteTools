odoo.define('biftool.import', function (require) {
"use strict";
...
function jsonp(form, attributes, callback) {
    ...
    var options = {jsonp: _.uniqueId('import_bif_callback_')};
...
var DataImport = Widget.extend(ControlPanelMixin, {
    ...
    renderButtons: function() {
        var self = this;
        this.$buttons = $(QWeb.render("ImportBifView.buttons", this));
    ...
    onresults: function (event, from, to, message) {
        ...
        this.$('.oe_import_error_report').html(
            QWeb.render('ImportBifView.error', {
            	message
            }));
    },
});
core.action_registry.add('biftool.import', DataImport);
