...
var ImportViewMixin = {
    ...
    init: function (viewInfo, params) {
        var importBifEnabled = 'importBifEnabled' in params ? params.importBifEnabled : false;
        // if true, the 'Import' button will be visible
        this.controllerParams.importBifEnabled = importBifEnabled;
    },
};
...
var ImportControllerMixin = {
    ...
    _bindImport: function () {
        ...
        var self = this;
        this.$buttons.on('click', '.o_button_import_bif', function () {
