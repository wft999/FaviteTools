odoo.define('padtool.submark', function (require) {
"use strict";
...
var Submark = Class.extend({
	...
	getPlygonSubMark:function(obj,dPeriodX, dPeriodY){
		if(obj.padType != 'subMark')
			return;
		...
		var offsetX = this.panel.globalConf.submark_offsetX;
		var offsetY = this.panel.globalConf.submark_offsetY;
	...
	getPanelPara: function(){
 		...
 		while(this.panel.bifConf['auops.subpanel.subpanel_'+id+'.global_subpanel_data'] != undefined){
    		...
    		var dOutputX = this.panel.coordinate.pmpPanelMapPara.dPanelCenterX;
    		var dOutputY = this.panel.coordinate.pmpPanelMapPara.dPanelCenterY;
    		if(dOutputX > left && dOutputX < right && dOutputY < bottom && dOutputY > top){
	    		...
	    		return {dPanelLeft,dPanelTop,dPanelRight,dPanelBottom,dPeriodX, dPeriodY};
    		}
    		id++;
 		}
 	 },
 	...
 	getNormalSubMark:function(dPanelLeft,dPanelBottom,dPanelRight,dPanelTop,dPeriodX, dPeriodY){
    	...
    	//Left Frame Mark
    	let {iIP:iIPIndex_Bottom, iScan:iScanIndex_Bottom} = this.panel.coordinate.JudgeIPScan_UM(dPanelLeft, dPanelBottom);
    	...
    	let {iIP:iIPIndex_Top, iScan:iScanIndex_Top} = this.panel.coordinate.JudgeIPScan_UM(dPanelLeft, dPanelTop);
    	...
    	{
    		//Down Camera
    		dScanRangeTop = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex_Bottom].aScanParaArray[iScanIndex_Bottom].dRange_Top;
    		dScanRangeLeft = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex_Bottom].aScanParaArray[iScanIndex_Bottom].dRange_Left;
    		dScanRangeRight = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex_Bottom].aScanParaArray[iScanIndex_Bottom].dRange_Right;
    		dResolutionX = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex_Bottom].aScanParaArray[iScanIndex_Bottom].dResolutionX;
    		dResolutionY = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex_Bottom].aScanParaArray[iScanIndex_Bottom].dResolutionY;
    		...
    		//Up Camera
    		dScanRangeBottom = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex_Top].aScanParaArray[iScanIndex_Top].dRange_Bottom;
    		dScanRangeLeft = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex_Top].aScanParaArray[iScanIndex_Top].dRange_Left;
    		dScanRangeRight = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex_Top].aScanParaArray[iScanIndex_Top].dRange_Right;
    		dResolutionX = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex_Top].aScanParaArray[iScanIndex_Top].dResolutionX;
    		dResolutionY = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex_Top].aScanParaArray[iScanIndex_Top].dResolutionY;
    	...
    	//Right
    	let {iIP:iIPIndex_Bottom2, iScan:iScanIndex_Bottom2} = this.panel.coordinate.JudgeIPScan_UM(dPanelRight, dPanelBottom);
    	...
    	let {iIP:iIPIndex_Top2, iScan:iScanIndex_Top2} = this.panel.coordinate.JudgeIPScan_UM(dPanelRight, dPanelTop);
    	...
    	//Bottom
    	let {iIP:iIPIndex_Left, iScan:iScanIndex_Left} = this.panel.coordinate.JudgeIPScan_UM(dPanelLeft, dPanelBottom);
    	...
    	let {iIP:iIPIndex_Right, iScan:iScanIndex_Right} = this.panel.coordinate.JudgeIPScan_UM(dPanelRight, dPanelBottom);
    	...
    	for(var iIPIndex = iIPIndex_Left; iIPIndex <= iIPIndex_Right; iIPIndex ++)
    	{
    		...
    		{
    			iScanIndexMax = this.panel.coordinate.mpMachinePara.iTotalScan - 1;
    		}
    		
    		for(var iScanIndex = iScanIndexMin; iScanIndex <= iScanIndexMax; iScanIndex ++)
    		{
    			dScanRangeLeft = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex].aScanParaArray[iScanIndex].dRange_Left;
    			dScanRangeRight = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex].aScanParaArray[iScanIndex].dRange_Right;
    			dResolutionX = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex].aScanParaArray[iScanIndex].dResolutionX;
    			dResolutionY = this.panel.coordinate.mpMachinePara.aIPParaArray[iIPIndex].aScanParaArray[iScanIndex].dResolutionY;
    	...
    	//Top
    	let {iIP:iIPIndex_Left2, iScan:iScanIndex_Left2} = this.panel.coordinate.JudgeIPScan_UM(dPanelLeft, dPanelTop);
    	...
    	let {iIP:iIPIndex_Right2, iScan:iScanIndex_Right2} = this.panel.coordinate.JudgeIPScan_UM(dPanelRight, dPanelTop);
