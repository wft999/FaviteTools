odoo.define('favite_bif.FrameWidgetInfo', function (require) {
"use strict";
...
widgetRegistry.add('subview_favite_bif_frame_info', WidgetInfo);
return WidgetInfo;

});


odoo.define('favite_bif.FrameWidgetMap', function (require) {
	"use strict";
...
odoo.define('favite_bif.FrameWidgetMapRaw', function (require) {
	"use strict";

	var core = require('web.core');
	var Dialog = require('web.Dialog');

	var WidgetMap = require('favite_bif.FrameWidgetMap');
...
//	        'keydown.canvas-map': '_onKeydown'
	...
	widgetRegistry.add('subview_favite_bif_frame_raw', WidgetMapRaw);

	});


odoo.define('favite_bif.FrameWidgetMapThumb', function (require) {
	"use strict";
...
//	        'keydown.canvas-map': '_onKeydown'
	...
	widgetRegistry.add('subview_favite_bif_frame_thumb', WidgetMapThumb);
