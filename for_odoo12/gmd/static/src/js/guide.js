odoo.define('web_guide.update_kanban', function (require) {
'use strict';
...
KanbanRecord.include({
    ...
    _openRecord: function () {
        if (this.modelName === 'web_guide.guide' && this.$(".o_tour_kanban_boxes a").length) {
    ...
    _onGlobalClick: function (ev) {
    	if (this.modelName === 'web_guide.guide' && $(ev.target).data('type') === 'play') {
			 ev.preventDefault();
			 
			 var self = this;
			 this._rpc({
				 model: 'web_guide.step',
				 method: 'search_read',
